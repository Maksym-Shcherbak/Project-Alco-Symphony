  ...
  const markup = arr
    .map(
      ...
      <div class="cocktail-card-controls">
        ...
        <button type="button" class="cocktail-card-button add" ><svg class="add-button-icon" width="26" height="26"><use href="../../img/cocktails/symbol-defs.svg#icon-heart"></use></svg></button>
      </div>
    </li>`
    )
    .join('');
