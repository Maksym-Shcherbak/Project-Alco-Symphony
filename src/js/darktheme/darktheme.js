...
//   );
//   // const swichBtn = querySelector('.switch');
...
//     sliderKnob.style.backgroundColor = '#ffffff'; // Slider knob color
//     slider.style.borderColor = '#ffffff'; // Slider outline border color
//   } else {
//     // Light mode styles (reset to defaults)
//     console.log('456');
//     sliderPath.style.backgroundColor = '#ffffff'; // Reset slider track color
//     sliderKnob.style.backgroundColor = '#9CDFDF'; // Reset slider knob color
//     slider.style.borderColor = '#000000'; // Reset slider outline border color
//   }
// }
...
function toggleFontColor(isDarkMode) {
  const fontColor = isDarkMode ? '#FDFDFF' : ''; // Change to white in dark mode
  const taglines = document.querySelectorAll(
    '.main-tagline, .sub-tagline, .menu-list, .favorite-coctails-subtitle, .pageAdditional, .header-logo-link, .favorite-coctails-title, .fav-coctail-description, .fav-coctail-titile, .drinkify-cocktails-title, .search-text'
  );
